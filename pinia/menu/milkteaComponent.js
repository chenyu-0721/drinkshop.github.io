...
export default {
  ...
  <div class="container ">
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3 my-4 ">
          <div class="col" v-show="product.variety === '奶茶'" v-for="product in sortProducts" :key="product.id">
              <div class="card" >
                  <img 
                  ...
                  <div class="card-body">
                      ...
                      <button  type="button"  class="btn btn-outline-primary w-100" id="liveToastBtn" @click.prevent="addToCard(product.title,product.id) ">加入購物車</button>
                  </div>
              </div>
          </div>         
      </div>
