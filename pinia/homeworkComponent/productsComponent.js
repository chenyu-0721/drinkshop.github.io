                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 py-4">
                        <div class="col">
                            <div class="card shadow-sm" style="height:470px;">
                                ...
                                <div class="card-body">
                                    <h4 class="border-bottom">綜合水果冰沙</h4>
                                    <p class="card-text">
                ...
                <div class="carousel-item">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 py-4">
                        ...
                        <div class="card shadow-sm" style="height:470px;">
                            ...
                            <div class="card-body">
                                <h4 class="border-bottom">日月潭紅茶</h4>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 py-4">
                        <div class="col">
                            <div class="card shadow-sm" style="height:470px;">
                                ...
                                <div class="card-body">
                                    <h4 class="border-bottom">藍色海洋</h4>
                        ...
                        <div class="col">
                            <div class="card shadow-sm" style="height:470px;">
                                ...
                                <div class="card-body">
                                    <h4 class="border-bottom">七彩繽紛</h4>
                        ...
                        <div class="card shadow-sm" style="height:470px;">
                            ...
                            <div class="card-body">
                                <h4 class="border-bottom">英式皇家奶茶</h4>
